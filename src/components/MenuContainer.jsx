    ...
    return (
        <section className='w-full my-6' id='menu'>
            <div className='w-full flex flex-col items-center justify-center'>
                ...
                before:w-16 before:h-1 before:-bottom-2 before:left-8 before:bg-gradient-to-tr from-orange-400 to-orange-600 
                ...
                <div className='w-full'>
                    <RowContainer 
                    flag={false}
                    data={foodItems?.filter((n) => n.categories == filter)}
                    />
                </div>
            </div>
        </section>
